...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate class="flex items-center">
                        <span class="font-semibold text-xl leading-tight text-center">Clínica MediaCare</span>
                        <x-application-logo class="block h-9 w-9 text-blue-700 fill-current" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('doctores.index')" :active="request()->routeIs('doctores.*')" wire:navigate>
                        {{ __('Doctors') }}
                    </x-nav-link>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center px-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out" style="background: #e5e7eb;font-size:2.25em">
                    ≡
                </button>
            </div>
        </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('doctores.index')" :active="request()->routeIs('doctores.*')" wire:navigate>
                {{ __('Doctors') }}
            </x-responsive-nav-link>
