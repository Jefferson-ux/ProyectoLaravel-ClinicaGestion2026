...
<div class="space-x-2 whitespace-nowrap flex items-center">
    ...
    @else
        <form action="{{ $restoreRoute }}" method="POST" class="inline">
            ...
            <button type="submit"
                    >
                <span title="Activar" class="btn bg-purple-600 hover:bg-purple-700 border-none btn-xs text-white shadow-sm shadow-purple-600/20 hover:shadow-md hover:shadow-purple-600/40 rounded-md transition-all duration-200 hover:scale-105 active:scale-95">
