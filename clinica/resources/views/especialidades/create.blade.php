                ...
                <div class="card-body">
                    <form action="{{ route('especialidades.store') }}" method="POST" class="space-y-4">
                        ...
                        <div class="form-control w-full">
                            ...
                            <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}" class="input input-bordered w-full @error('nombre') input-error @enderror" required>
                        ...
                        <div class="form-control w-full">
                            ...
                            <textarea id="descripcion" name="descripcion" rows="3" class="textarea textarea-bordered w-full @error('descripcion') textarea-error @enderror">{{ old('descripcion') }}</textarea>
