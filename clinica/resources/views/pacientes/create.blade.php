                    ...
                    <form action="{{ route('pacientes.store') }}" method="POST" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-control w-full">
                                ...
                                <input type="date" id="fecha_nacimiento" name="fecha_nacimiento" value="{{ old('fecha_nacimiento') }}" class="input input-bordered w-full @error('fecha_nacimiento') input-error @enderror">
                            ...
                            <div class="form-control w-full md:col-span-2">
                                ...
                                <input type="text" id="direccion" name="direccion" value="{{ old('direccion') }}" class="input input-bordered w-full @error('direccion') input-error @enderror">
