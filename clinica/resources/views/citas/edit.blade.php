                ...
                >
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <x-form-field :label="__('Patient')" for="id_paciente" :error="$errors->first('id_paciente')">
                            <select id="id_paciente" name="id_paciente"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5 px-3 @error('id_paciente') border-red-500 @enderror"
                                required>
                        ...
                        <x-form-field :label="__('Doctor')" for="id_doctor" :error="$errors->first('id_doctor')">
                            <select id="id_doctor" name="id_doctor"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5 px-3 @error('id_doctor') border-red-500 @enderror"
                                required>
                        ...
                        <x-form-field :label="__('Date')" for="fecha" :error="$errors->first('fecha')">
                            <input type="date" id="fecha" name="fecha" value="{{ old('fecha', $cita->fecha) }}"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5 px-3 @error('fecha') border-red-500 @enderror"
                                required>
                        </x-form-field>
                        ...
                        <x-form-field :label="__('Time')" for="hora" :error="$errors->first('hora')">
                            <input type="time" id="hora" name="hora" value="{{ old('hora', \Illuminate\Support\Str::of($cita->hora)->substr(0, 5)) }}"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5 px-3 @error('hora') border-red-500 @enderror"
                                required>
                        </x-form-field>

                        <x-form-field :label="__('Status')" for="estado" :error="$errors->first('estado')">
                            <select id="estado" name="estado" x-model="estado"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5 px-3 @error('estado') border-red-500 @enderror">
                    ...
                    <x-form-field :label="__('Reason')" for="motivo" :error="$errors->first('motivo')">
                        <textarea id="motivo" name="motivo" rows="3"
                            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5 px-3">{{ old('motivo', $cita->motivo) }}</textarea>
                    </x-form-field>
