                    ...
                    <form action="{{ route('doctores.update', $doctor->id) }}" method="POST" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="form-control w-full">
                                ...
                                <input type="text" id="dni" name="dni" value="{{ old('dni', $doctor->dni) }}" maxlength="8" class="input input-bordered w-full @error('dni') input-error @enderror" required>
                            ...
                            <div class="form-control w-full">
                                ...
                                <input type="text" id="nombres" name="nombres" value="{{ old('nombres', $doctor->nombres) }}" class="input input-bordered w-full @error('nombres') input-error @enderror" required>
                            ...
                            <div class="form-control w-full">
                                ...
                                <input type="text" id="apellidos" name="apellidos" value="{{ old('apellidos', $doctor->apellidos) }}" class="input input-bordered w-full @error('apellidos') input-error @enderror" required>
                            ...
                            <div class="form-control w-full">
                                ...
                                <input type="text" id="telefono" name="telefono" value="{{ old('telefono', $doctor->telefono) }}" class="input input-bordered w-full @error('telefono') input-error @enderror">
                            ...
                            <div class="form-control w-full">
                                ...
                                <input type="email" id="correo" name="correo" value="{{ old('correo', $doctor->correo) }}" class="input input-bordered w-full @error('correo') input-error @enderror">
                        ...
                        <div class="form-control">
                            <label class="label cursor-pointer justify-start gap-3">
                                <input type="checkbox" name="estado" value="1" class="checkbox checkbox-primary" {{ old('estado', $doctor->estado) ? 'checked' : '' }}>
